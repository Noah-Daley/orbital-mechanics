...
var ASM_CONSTS = {
  89806: () => { if (document.fullscreenElement) return 1; },  
 89852: () => { return Module.canvas.width; },  
 89884: () => { return parseInt(Module.canvas.style.width); },  
 89932: () => { document.exitFullscreen(); },  
 89959: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 90031: () => { if (document.fullscreenElement) return 1; },  
 90077: () => { return Module.canvas.width; },  
 90109: () => { return screen.width; },  
 90134: () => { document.exitFullscreen(); },  
 90161: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 90355: () => { return window.innerWidth; },  
 90381: () => { return window.innerHeight; },  
 90408: () => { if (document.fullscreenElement) return 1; },  
 90454: () => { return Module.canvas.width; },  
 90486: () => { return parseInt(Module.canvas.style.width); },  
 90534: () => { if (document.fullscreenElement) return 1; },  
 90580: () => { return Module.canvas.width; },  
 90612: () => { return screen.width; },  
 90637: () => { return window.innerWidth; },  
 90663: () => { return window.innerHeight; },  
 90690: () => { if (document.fullscreenElement) return 1; },  
 90736: () => { return Module.canvas.width; },  
 90768: () => { return screen.width; },  
 90793: () => { document.exitFullscreen(); },  
 90820: () => { if (document.fullscreenElement) return 1; },  
 90866: () => { return Module.canvas.width; },  
 90898: () => { return parseInt(Module.canvas.style.width); },  
 90946: () => { document.exitFullscreen(); },  
 90973: ($0) => { Module.canvas.style.opacity = $0; },  
 91011: () => { return screen.width; },  
 91036: () => { return screen.height; },  
 91062: () => { return window.screenX; },  
 91089: () => { return window.screenY; },  
 91116: () => { return window.devicePixelRatio; },  
 91152: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 91205: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 91256: () => { Module.canvas.style.cursor = 'none'; },  
 91293: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 91549: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 91600: () => { if (document.pointerLockElement) return 1; },  
 91647: () => { if (document.fullscreenElement) return 1; },  
 91693: () => { return window.innerWidth; },  
 91719: () => { return window.innerHeight; }
};
